...
public:
    CMainParams()
    {
        ...
        nBlockFirstFraudulent = 1110; //First block that bad serials emerged
        nBlockLastGoodCheckpoint = 1001; //Last valid accumulator checkpoint
	...
	if(genesis.GetHash() != uint256("000002ea9fe3bbe0eb619805faf25699969ec7fb180787ef779abfdc47d88316"))
        {
...
public:
    CTestNetParams()
    {
        ...
        hashGenesisBlock = genesis.GetHash();
	if(genesis.GetHash() != uint256("000001bf9d7e6b0bdb36ae34d4060b501103b0d5db29177a41f37ed4bb61899f"))
        {
            printf("Searching for genesis block...\n");
            uint256 hashTarget = CBigNum().SetCompact(genesis.nBits).getuint256();
            while(uint256(genesis.GetHash()) > hashTarget)
